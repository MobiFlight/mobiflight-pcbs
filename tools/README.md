...
These files can be used in KiCAD to batch export board images and schema pdf, as well as the STEP 3D model.
This file is shared, so in your kicad project, select `File > Open Jobset file...` to load the jobset.

Then click the "Generate" button in the jobset panel.
